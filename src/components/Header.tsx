        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex space-x-1">
              <Link href="/" className="text-sm font-medium text-gray-600 hover:text-blue-700 px-3 py-2 rounded-md hover:bg-gray-50 transition-all duration-300 ease-in-out flex items-center">
                <FileText className="mr-1 h-4 w-4" />
                Home
              </Link>
             <Link href="/user-forms" className="text-sm font-medium text-gray-600 hover:text-blue-700 px-3 py-2 rounded-md hover:bg-gray-50 transition-all duration-300 ease-in-out flex items-center">
                <FileText className="mr-1 h-4 w-4" />
                Forms
              </Link>
              <Link href="/about" className="text-sm font-medium text-gray-600 hover:text-blue-700 px-3 py-2 rounded-md hover:bg-gray-50 transition-all duration-300 ease-in-out flex items-center">
                <MessageCircle className="mr-1 h-4 w-4" />
                About
              </Link>
              <Link href="/contact" className="text-sm font-medium text-gray-600 hover:text-blue-700 px-3 py-2 rounded-md hover:bg-gray-50 transition-all duration-300 ease-in-out flex items-center">
                <MessageCircle className="mr-1 h-4 w-4" />
                Contact
              </Link>
            </nav>
          ...
          <div className="flex items-center space-x-4">
            <Button 
              ...
              className="text-sm font-semibold text-blue-700 hover:text-blue-800 border-gray-300 hover:border-blue-300 hover:bg-gray-50 rounded-md transition-all duration-300 flex items-center gap-1"
            >
